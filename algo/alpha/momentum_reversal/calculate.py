...
class MomentumReversalTradingParam:
    ...
    def get_default_param():
        return MomentumReversalTradingParam(
...
def _is_long(features, trading_param: MomentumReversalTradingParam):
    return features['rank'] <= trading_param.selection_size and features['momentum'] < 0

def _is_short(features, trading_param: MomentumReversalTradingParam):
...
class Status:
    ...
    def update(self, t: datetime.datetime, features: dict, trading_param: MomentumReversalTradingParam) -> None:

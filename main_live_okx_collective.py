...
trade_execution = trading.execution_okx.TradeExecution(target_betsize=20, leverage=2)
...
trade_execution_small_drop = trading.execution_okx.TradeExecution(target_betsize=20, leverage=2)

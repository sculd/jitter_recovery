...
trade_execution = trading.execution_okx.TradeExecution(target_betsize=30, leverage=3)
...
trade_execution_small_drop = trading.execution_okx.TradeExecution(target_betsize=30, leverage=3)

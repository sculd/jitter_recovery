...
trade_execution = trading.execution_okx.TradeExecution(target_betsize=40, leverage=5)
...
trade_execution_small_drop = trading.execution_okx.TradeExecution(target_betsize=40, leverage=5)
